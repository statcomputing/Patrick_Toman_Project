...
4. Model Implementation
  + Built function to find MLE of Model 1 from authors paper - Separate model for each station with possible common trend
  + Function computes return levels as well
